package jiraiyah.ultraio_command.command;

import com.mojang.brigadier.arguments.StringArgumentType;
import jiraiyah.ultraio_command.MainCommand;
import jiraiyah.ultraio_command.command.suggestion.DevCleanSuggestionProvider;
                                                                      ...
                                                                      .executes(context ->
                                                                                {
                                                                                    ...
                                                                                    {
                                                                                        context.getSource().sendFeedback(() -> MainCommand.REFERENCE.translate(MainCommand.REFERENCE.DCLR_ERROR_ID_NAME), false);
                                                                                    }
                                                                                    else
                                                                                    {
                                                                                        ...
                                                                                        if (player != null)
                                                                                        {
                                                                                            ...
                                                                                            int minX = position.getX() - MainCommand.CONFIG.DCLR_RADIUS;
                                                                                            int maxX = position.getX() + MainCommand.CONFIG.DCLR_RADIUS;
                                                                                            int minZ = position.getZ() - MainCommand.CONFIG.DCLR_RADIUS;
                                                                                            int maxZ = position.getZ() + MainCommand.CONFIG.DCLR_RADIUS;

                                                                                            context.getSource().sendFeedback(() -> MainCommand.REFERENCE.translate(MainCommand.REFERENCE.DCLR_START_ID_NAME), false);
                                                                                            ...
                                                                                            context.getSource().sendFeedback(() -> MainCommand.REFERENCE.translate(MainCommand.REFERENCE.DCLR_END_ID_NAME), false);
                                                                                        }
                                                                                    }
                                                                                    return 1;
                                                                                })));
